...
public class ListenerApiController implements ListenerApi {
    ...
    public ResponseEntity<EventSubscription> listenToServiceOrderStateChangeEvent(@Parameter(in = ParameterIn.DEFAULT, description = "The event data", required=true, schema=@Schema()) @Valid @RequestBody ServiceOrderStateChangeEvent body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<EventSubscription>(objectMapper.readValue("{\n  \"query\" : \"query\",\n  \"callback\" : \"callback\",\n  \"id\" : \"id\"\n}", EventSubscription.class), HttpStatus.NOT_IMPLEMENTED);
