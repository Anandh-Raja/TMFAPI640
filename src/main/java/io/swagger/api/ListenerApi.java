...
public interface ListenerApi {
    ...
    @RequestMapping(value = "/listener/serviceOrderStateChangeEvent",
        ...
        consumes = { "application/json;charset=utf-8" }, 
        method = RequestMethod.POST)
    ResponseEntity<EventSubscription> listenToServiceOrderStateChangeEvent(@Parameter(in = ParameterIn.DEFAULT, description = "The event data", required=true, schema=@Schema()) @Valid @RequestBody ServiceOrderStateChangeEvent body);
